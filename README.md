...
The CRREM plugin for [KITModelViewer]()can be used to display the CRREM pathways provided via the [NaiS database](). The parameters required for this are derived from 3D building models.
